...
export function Nav() {
  ...
  const supportsScopedView = path === '/dashboard' || path === '/transactions' || path === '/crypto' || path === '/available-cash' || path === '/category-tracker';
  ...
  return <aside className="border-r border-slate-800 bg-navy text-slate-300 md:min-h-screen md:w-60"><div className="p-5 text-lg font-bold text-white">PF<span className="text-mint">OS</span><p className="mt-1 text-xs font-normal text-slate-400">Personal financial operating system</p>
